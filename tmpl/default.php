					...
					<div class="card-header">
						...
						<div class="module-actions">
							<a href='<?php echo $show_all_link ?>' class='adminlink'>
								...
								echo "</a></div>";	?>
								<h3 class="module-title"><i class="icon-large icon-featured"></i>
									<?php echo JText::_('FLEXI_ADMIN_FEATURED'); ?></h3>
						</div>
						...
						<div class="card-header">
							...
							<div class="module-actions">
								<a href='<?php echo $show_all_link ?>' class='adminlink'>
									...
									echo JText::_('FLEXI_ADMIN_ALL');
									echo "</a></div>";	?>
									<h3 class="module-title "><i class="fa fa-spinner"></i>
										<?php echo JText::_('FLEXI_ADMIN_PENDING'); ?></h3>
							</div>
							<div class="card-body" style="height:<?php echo $forceheightblock; ?>">
								<table class="table" id="<?php echo str_replace(' ', '', $module->title) . $module->id; ?>">
									<thead>
							...
							<div class="card-header">
								...
								<div class="module-actions">
									<a href='<?php echo $show_all_link ?>' class='adminlink'>
										...
										echo JText::_('FLEXI_ADMIN_ALL');
										echo "</a></div>";	?>
										<h3 class="module-title"><i class="icon-large icon-thumbs-up"></i> <?php echo JText::_('FLEXI_ADMIN_REVISED'); ?></h3>
								</div>
								...
								<div class="card-header">
									...
									<div class="module-actions">
										<a href='<?php echo $show_all_link ?>' class='adminlink'>
											...
											echo JText::_('FLEXI_ADMIN_ALL');
											echo "</a></div>";	?>
											<h3 class="module-title"><i class="icon-large icon-checkin"></i> <?php echo JText::_('FLEXI_ADMIN_INPROGRESS'); ?></h3>
									</div>
											...
											<tbody>
												...
												<?php foreach ($listInprogress as $itemInprogress) : ?>
													<tr>
														...
														<td>
															<span class="small">
																<i class="fa fa-user"></i> <?php echo $itemInprogress->name; ?></small>
															</span>
														</td>
														<td>
															<span class="small">
									...
									<div class="card-header">
										...
										<div class="module-actions">
											<a href='<?php echo $show_all_link ?>' class='adminlink'>
												...
												echo JText::_('FLEXI_ADMIN_ALL');
												echo "</a></div>";	?>
												<h3 class="module-title"><i class="icon-large icon-file"></i> <?php echo JText::_('FLEXI_ADMIN_DRAFT'); ?></h3>
										</div>
										<div class="card-body" style="height:<?php echo $forceheightblock; ?>">
											<table class="table" id="<?php echo str_replace(' ', '', $module->title) . $module->id; ?>">
												<thead>
												...
												<tbody>
													<?php foreach ($listDraft as $itemDraft) : ?>
														<tr>
															...
															<td>
																<span class="small">
																	<i class="fa fa-user"></i> <?php echo $itemDraft->name; ?></small>
																</span>
															</td>
															<td>
																<span class="small">
														...
														<div class="card-body" style="height:<?php echo $forceheightblock; ?>">
															...
															<?php if (count($actionlist)) : ?>
																<table class="table">
																	<thead>
																		<tr>
																			<th scope="col" class="w-80"><?php echo Text::_('FLEXI_LATEST_ACTIONS'); ?></th>
																			<th scope="col" class="w-20"><?php echo Text::_('JDATE'); ?></th>
																		</tr>
																	</thead>
																	<tbody>
